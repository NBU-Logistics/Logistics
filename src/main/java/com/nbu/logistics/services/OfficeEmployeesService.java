...
//
//        Optional<OfficeEmployee> office = this.officeEmployeesRepository.findById(id);
//
...
//      OfficeEmployee existingEmployee = this.officeEmployeesRepository.findByUserById(officeEmployeesRepository.getOne(id));
        if (id == 0) {
